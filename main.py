...
def command_start(update, context: CallbackContext):
    if update.effective_chat.type == "private":
        ...
        update.message.reply_text(' Salam Mən Söz Oyun Botuyam Oynamaq Üçün Məni Qrupunuza Əlave Edin! Kömek Üçün /komek@SozOyunuFarzBot Komutunu İşledin', reply_to_message_id=True, reply_markup=reply_markup)
    else:
